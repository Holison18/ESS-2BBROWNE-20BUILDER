        ...
        <div className="container mx-auto px-4 lg:px-20">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16 mb-12">
            ...
            <div>
              ...
              <Link
                to="/contact"
                className="bg-home-button hover:bg-orange transition-colors rounded-full px-8 py-4 text-text-color font-noto text-lg lg:text-xl inline-flex items-center gap-3"
              >
                Send Message
                <svg
                  width="32"
