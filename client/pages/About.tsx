            ...
            <div className="relative flex justify-center items-center py-12 lg:py-0">
              ...
              >
                <h2 className="text-text-color font-outfit text-3xl lg:text-4xl font-semibold mb-4 uppercase">
                  WHO WE <span className="text-orange">ARE?</span>
                </h2>
                <p className="text-text-color font-noto text-base lg:text-lg leading-relaxed">
                  ESS+BROWNE is a leading design and build firm committed to
                  creating exceptional spaces that inspire and delight. With a
                  foundation built on integrity, creativity, and quality, we
                  partner with our clients to bring their dreams to life.
                </p>
              </motion.div>
            </div>
          </div>
