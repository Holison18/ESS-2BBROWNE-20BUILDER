  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 lg:px-20">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            <div className="relative">
              <h1 className="text-text-color font-outfit text-5xl lg:text-7xl xl:text-8xl font-semibold leading-tight mb-8 uppercase">
            ...
            <div className="space-y-8">
              {/* Large Decorative Circle with content */}
              <div className="relative">
                <svg className="w-full max-w-md mx-auto" viewBox="0 0 373 373" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="186.5" cy="186.5" r="186" stroke="#F79723" />
                </svg>
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-center p-12">
                  ...
                  <p className="text-text-color font-noto text-lg lg:text-xl leading-relaxed text-center">
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4 lg:px-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="bg-text-grey p-8 lg:p-12 rounded-lg">
                <p className="text-[#E3E3E3] font-noto text-xl lg:text-2xl leading-relaxed">
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="container mx-auto px-4 lg:px-20">
          <div className="mb-12">
            <p className="text-text-color font-outfit text-xl lg:text-2xl font-medium mb-4">TEAM</p>
