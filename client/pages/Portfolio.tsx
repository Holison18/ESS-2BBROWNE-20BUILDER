...
export default function Portfolio() {
  ...
  const allDisplayProjects = dbProjects.length === 1 
    ? Array(18).fill(null).map((_, i) => ({
        ...dbProjects[0],
        id: `${dbProjects[0].id}-${i}`, 
        status: ["completed", "ongoing", "not-started"][i % 3] as FilterType,
      }))
    : dbProjects;
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
        ...
        <div className="container mx-auto px-4 lg:px-20">
          <div className="flex items-center justify-between py-4 lg:py-6">
            ...
            <div className="hidden md:flex items-center gap-8 lg:gap-12 text-text-color font-noto text-base lg:text-lg font-medium">
              ...
              <Link to="/portfolio" className="text-orange">PORTFOLIO</Link>
      ...
      {/* Main Content - Added 'flex-grow' to push footer down if content is short */}
        ...
        <div className="container mx-auto px-4 lg:px-20">
          ...
          <div className="mb-12">
            ...
            <p className="text-gray-500 font-noto text-lg max-w-2xl">
              Explore our curated selection of architectural projects, showcasing innovation, elegance, and functional design across Ghana.
            </p>
          </div>
          ...
          {isLoading ? (
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[1,2,3].map(i => <Skeleton key={i} className="h-[350px] w-full rounded-none" />)}
             </div>
          ) : (
            <motion.div 
              layout
